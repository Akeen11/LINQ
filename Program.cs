...
namespace linq {
    ...
    class Program {
        static void Main (string[] args) 
        {
            ...
            List<int> fourSixMultiples = (numbers.Where(x => x % 4 == 0).Where(x => x % 6 == 0)).ToList();
            ...
            List<int> ascend = (from number in numbers2
            orderby number
            ...
            */
            ...
            /*
                ...
                CITI 1
            */
            var milliReports = from customer in customers
                where customer.Balance >= 1000000
                group customer by customer.Bank into report
                select new { Bank = report.Key, customers = report };

            Console.WriteLine ("--------------------");
            foreach (var milliReport in milliReports) 
            {
                Console.WriteLine ($"{milliReport.Bank} {milliReport.customers.Count()}");
            }
        }
    }
}